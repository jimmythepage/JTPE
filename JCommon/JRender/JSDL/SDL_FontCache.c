...
FC_Rect JDraw(FC_Font* font, FC_Target* dest, float x, float y, FC_Scale scale,SDL_Color color, FC_AlignEnum align, const char* text,...)
{
	if (text == NULL || font == NULL)
		return FC_MakeRect(x, y, 0, 0);

	FC_EXTRACT_VARARGS(fc_buffer, text);
